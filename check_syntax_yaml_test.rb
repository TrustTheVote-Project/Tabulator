...
# schema_setup
#
# * <i>trace</i>:    [type Integer] limits tracing of output for the syntax checker
# * <i>prefix</i>:   [type String] prefix of the schema file name
# * <i>schema</i>:   [type Arbitrary] schema to be written to a schema file
# * <i>validate</i>: [type Boolean] indicates when to check the validity of the schema (optional, default <i>true</i>)
# * <i>write</i>:    [type Boolean] indicates when to over-write the schema file (optional, default <i>false</i>)
#
# Returns: N/A
#
...
# * <i>postfix</i>: [type String] postfix for the data file name (optional, default '')
#
# Returns: Boolean
#
...
# check of the datum against the schema.
  ...
  def schema_test_syntax(trace, prefix, postfix = '')
    ...
    assert(CheckSyntaxYaml.new.check_syntax(schema, datum, true, trace),
           "Check Syntax of #{prefix} FAILED")
    print "Check Syntax of #{prefix}: OK\n\n"
  end
  
# schema_test_syntax_error
#
# * <i>trace</i>:     [type Integer] limits tracing of output for the syntax checker
# * <i>prefix</i>:    [type String] prefix of the schema and data file names
# * <i>validate</i>:  [type Boolean] indicates when the schema is to be validated
# * <i>err1</i>:      [type Integer] error code 1
# * <i>err2</i>:      [type Integer] error code 2 (optional, default -1)
# * <i>err3</i>:      [type Integer] error code 3 (optional, default -1)
#
# Returns: Boolean
#
